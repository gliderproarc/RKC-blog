...
Once you save your work, you have lost the blank version of My_book.txt. You
only have one current and correct version of My_book.txt. In most cases this is
...
My_book.txt after you deleted A? What do you do now? Well if you have an "old"
...
"My_book_with_the_cool_ending.txt" to see if this is the one you were looking for.
